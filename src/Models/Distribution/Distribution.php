...
use Zahzah\ModuleDistribution\Resources\Distribution\{
    ViewDistribution, ShowDistribution
};
...
class Distribution extends BaseModel
{
    ...
    protected $list = [
        'id','distribution_no','order_no','flag',
        'receiver_id','receiver_type',
        'sender_id','sender_type',
        'status', 'ordered_at', 'distributed_at'        
    ];
    protected $show = [
        'author_sender_type', 'author_sender_id',
        'author_receiver_type', 'author_receiver_id'
    ];
    ...
    public function authorSender(){return $this->morphTo();}
    public function authorReceiver(){return $this->morphTo();}
